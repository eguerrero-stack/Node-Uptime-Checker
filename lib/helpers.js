...
helpers.createRandomString = function (strLength) {
  ...
  if (strLength) {
    // Define all the possble characters that could go into a string
...
helpers.sendTwilioSms = function (phone, msg, callback) {
  ...
  if (phone && msg) {
    ...
    //Not a json content type, tradition api hence the querystringify above
    var requestDetails = {
      protocol: "https:",
    ...
    var req = https.request(requestDetails, function (res) {
      ...
      //Callback successfully if the request went through, false means no error
