...
workers.performCheck = function (originalCheckData) {
  ...
  var req = _moduleToUse.request(requestDetails, function (res) {
    ...
    //This is where we can peek into the information of each request
    // console.log("these are the request details = ", requestDetails);
...
workers.processCheckOutcome = function (originalCheckData, checkOutcome) {
  ...
  console.log("These are the check outcomes= ", checkOutcome);
  console.log("Original Check Data", originalCheckData.successCodes);
  var state =
    !checkOutcome.error &&
...
// Time to execture the log rotation process once per day
