...
cli.responders.help = function () {
  var commands = {
    ...
    stats:
      "Get statistics on the underlying operation system and resource utilization",
    "list users":
    ...
    "list logs":
      "Show a list of all the log files available to read (compressed only}",
...
cli.processInput = function (str) {
  ...
  // Only the process the input if the user actually wrote something. Otherwise ignore
  if (str) {
...
cli.init = function () {
  ...
  console.log("\x1b[34m%s\x1b[0m", "The CLI is is running");
